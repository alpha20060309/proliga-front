...
const SettingsNavigation = ({ setTab, currentTab }) => {
  return (
    <aside className="flex h-auto w-full flex-row space-x-0.5 rounded-xl bg-neutral-900/80 bg-opacity-90 p-2 backdrop-blur-sm fade-in lg:w-64 lg:flex-col lg:p-4 xl:gap-1">
