...
const TransactionsTableHead = ({ table }) => {
  return (
    <thead>
              ...
              <th
                ...
                {...{
                  className: header.column.getCanSort()
                    ? 'cursor-pointer text-center select-none px-0.5 py-1 text-xs xs:text-sm lg:text-base font-medium md:px-1 md:text-start min-w-6 sm:min-w-max'
