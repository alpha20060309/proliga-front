...
const ProfileStadiumForm = () => {
  ...
  return (
    ...
    >
      ...
      >
        <SelectTrigger className="xs:px-2 text-foreground bg-background dark:bg-background hover:border-primary border-muted w-36 rounded-sm px-1.5 text-xs data-[size=default]:h-10 sm:w-40 md:w-48">
