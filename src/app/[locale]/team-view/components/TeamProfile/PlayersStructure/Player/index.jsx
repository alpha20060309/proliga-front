      ...
      {player.name && (
        <>
          ...
          <div className="flex items-center gap-0.5">
            <div className="bg-primary border-border text-secondary-foreground flex h-4 w-6 cursor-default items-center justify-center rounded-sm border text-center text-xs font-bold sm:h-5 sm:w-8 md:text-sm">
              {player.is_captain
