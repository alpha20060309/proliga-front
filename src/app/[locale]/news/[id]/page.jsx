...
export async function generateMetadata({ params }) {
    ...
    const title = getCorrectName({ lang: locale, ru: news.name_ru, uz: news.name })
    ...
    if (news.image) {
        metadata.openGraph.images = [{ url: news.image }]
    }
...
export default async function NewsPage({ params }) {
    ...
    return (
        <Card className="border-border my-4 min-h-screen">
            <CardHeader>
