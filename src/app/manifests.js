export default function manifest() {
  return {
    "name": "Proliga - Платформа Фэнтези-Футбола",
    "short_name": "Proliga",
    "description": "Фэнтези-футбольная лига Узбекистана — виртуальная футбольная игра, основанная на настоящих игроках футбольных лиг",
    "start_url": "/",
    "launch_handler": {
      "platform": "windows",
      "url": "/"
    ...
    "related_applications": [
      {
        "platform": "play",
        "url": "https://play.google.com/store/apps/details?id=com.sleeperbot.lite",
        "id": "com.sleeperbot.lite"
      },
      {
        "platform": "play",
        "url": "https://play.google.com/store/apps/details?id=com.uefa.eurofantasy",
        "id": "com.uefa.eurofantasy"
      }
    ]
  }
