...
export function PrizesSkeleton({ count = 4 }) {
  return (
    <>
      <Skeleton className="mb-4 h-12 w-48 bg-neutral-500" />
...
export function CompetitionSkeleton() {
  return (
    <div className="flex flex-col rounded-xl border border-neutral-100/50 bg-background/25 p-2 backdrop-blur-xs md:p-4">
