...
const ClubsFilter = ({ column }) => {
  ...
  return (
    <Select onValueChange={(value) => column.setFilterValue(value)}>
      <SelectTrigger className="bg-background text-secondary-foreground col-span-1 h-8 w-full max-w-56 truncate rounded-sm border border-neutral-500 px-2 shadow-sm sm:max-w-36 md:max-w-48">
        <SelectValue />
      </SelectTrigger>
      <SelectContent>
