  ...
  return (
    <div className="flex w-full items-center gap-1 text-sm sm:col-span-1 md:text-base">
      <Select
        ...
        defaultValue={MIN[0]}
      >
        <SelectTrigger className="h-8 w-full min-w-8 max-w-24 select-none rounded-sm border border-neutral-500 bg-background text-secondary-foreground md:min-w-max">
          <SelectValue />
        </SelectTrigger>
        <SelectContent>
          {MIN.map((item, index) => (
