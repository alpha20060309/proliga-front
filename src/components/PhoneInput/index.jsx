...
const InputComponent = React.forwardRef(({ className, ...props }, ref) => (
  <Input
    className={cn(
      'rounded-e-md rounded-s-none border-inherit bg-inherit text-neutral-200 placeholder:text-neutral-500 md:text-base',
      className
    )}
    {...props}
    ref={ref}
    ...
    <Popover>
      <PopoverTrigger asChild>
        <Button
          ...
          variant={'outline'}
          className={cn(
            'flex gap-1 rounded-e-none rounded-s-md border-y border-l border-r-0 border-inherit bg-inherit px-2 text-sm'
          )}
          disabled={disabled}
        >
