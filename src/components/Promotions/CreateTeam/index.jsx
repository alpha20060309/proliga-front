...
const PromotionCreateTeam = ({ t }) => {
  return (
    <Card className="relative h-full flex-1 rounded-none border-t-0 border-x-0 border-inherit shadow-none">
      ...
      <CardContent className="flex h-full max-h-[42rem] px-0 w-full flex-col gap-4 lg:gap-0 lg:grid lg:grid-cols-2 lg:grid-rows-1">
        <div className="flex h-full flex-col gap-2 sm:gap-4 md:gap-8">
          ...
          <CardDescription className="xs:text-base text-sm md:text-lg max-w-lg xl:max-w-xl lg:text-lg xl:text-xl">
            {t('promotion_text')}
          </CardDescription>
          <Image
            width={200}
