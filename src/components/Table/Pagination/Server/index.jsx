    ...
    for (let i = startPage; i <= endPage; i++) {
      ...
      pageNumbers.push(
        <Button
          ...
          className={cn(
            'bg-background border-muted text-foreground hover:bg-accent hover:text-accent-foreground size-6 xs:size-7 border p-0 md:size-8',
            isCurrentPage &&
  ...
  return (
    ...
    >
      <Button
        ...
        size="sm"
        className={cn(
          'bg-background text-foreground hover:bg-accent hover:text-accent-foreground border-border size-6 xs:size-7 p-0 md:size-8',
          buttonClassName
        )}
  ...
  return (
    <div className={cn('flex h-full justify-center space-x-2', className)}>
      <Button
        variant="outline"
        disabled
        className="bg-muted text-muted-foreground border-border size-6 xs:size-7 animate-pulse cursor-pointer p-0 md:size-8"
      >
      ...
      {Array.from({ length: count }).map((_, index) => (
        <Skeleton key={index} className="bg-muted size-6 xs:size-7 md:size-8" />
      ))}
      <Button
        variant="outline"
        disabled
